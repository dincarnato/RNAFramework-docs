...
```bash
$ rf-motifdiscovery [options] -b peaks.bed -f transcripts.fasta
```
...
__-f__ *or* __--fasta__ | string | A FASTA file containing the reference transcript sequences (mandatory)
